...
public class Template2 {
	public static ByteArrayOutputStream generateTemplate() throws IOException
	{
		...
		Paragraph header = new Paragraph("TEMPLATE 2")
		...
		table.addCell(cell);
		cell = new Cell().add("Last Bill Calculation Date");
		table.addCell(cell);
		cell = new Cell();
		cell.setNextRenderer(new MyCellRenderer(cell, "LastBillCalculationDate"));
		table.addCell(cell);
		doc.add(table);
